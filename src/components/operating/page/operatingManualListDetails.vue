<template>
    ...
    <van-list  v-model="loading" :finished="finished" :finished-text="test"  @load="getNextPage" style="height:100%">
    <topSolt style="height:calc(100% - 1.55rem);" >
    <ul slot="returnTopSolt">
...
export default {
  ...
  methods: {
    ...
    getdata(){
    	this.$axios.get('/manager/operating-manual-section-tracks?'
