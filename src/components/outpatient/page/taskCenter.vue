		...
		<van-overlay :show="showExplain" @click="showExplain = false">
			<div class="explainContent">
				...
				<div class="explainRulenNum">
					<p>1.首次收益为第一次的任务收益：每个用户仅可领取一次。首次上传病源可一次领取20000积分；首次确认就诊即给上级医院输送的病源首次被确认就诊，用户可得20000积分；首次浏览文章可获得20000积分；首次分享文章获得20000积分。</p>
					<p>2.每日收益为每天都可以做的任务，每天都可领取到的积分。每日首次登录获得1分；上传病源每位20分，上限200分；浏览文章5分，上限10分；分享文章5分，上限10分；上级医院确认就诊20分一位，上限200分；文章推广即分享出去的文章获得的点击量，2分一个，上限20分。</p>
				</div>
