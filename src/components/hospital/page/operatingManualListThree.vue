  ...
  methods: {
    ...
    nextPageFn(item){
      ...
      if(item.lowerCount){
        ...
        this.$router.push({name:'hospital_operatingManualListFour',query:{name:item.name,operatingManualId:this.$route.query.operatingManualId,operatingManualSectionId : item.operatingManualSectionId,time: new Date().getTime().toString()}})
      }else{
